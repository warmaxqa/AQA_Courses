...
filtered_cars = [
    ...
    if details[1] >= criteria[0] and details[2] >= criteria[1] and details[4] <= criteria[2]]

sorted_filtered_cars = sorted(filtered_cars, key=lambda x: x[1][4])

for car, details in sorted_filtered_cars[:5]:
    print(f"Марка: {car}, Колір: {details[0]}, Рік: {details[1]}, Об'єм двигуна: {details[2]}, Тип: {details[3]}, Ціна: ${details[4]}")